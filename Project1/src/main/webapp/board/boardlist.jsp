...
switch (boardno) {
case 1:  boardtype = "공지사항"; break;
case 2:  boardtype = "자유게시판"; break;
case 3:  boardtype = "게임게시판"; break;
case 4:  boardtype = "쇼핑게시판"; break;
case 5:  boardtype = "맛집&요리게시판"; break;
}
%>   
...
<body>
<div class="container" style="width: 920px; height:800px; text-align: center; margin-top: 50px" >
<h1><%=boardtype%></h1>
