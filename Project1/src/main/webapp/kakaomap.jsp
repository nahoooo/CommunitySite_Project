...
<head>
<meta charset="UTF-8">
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=08b402e028254d6d57047b09a9521f83&libraries=services,clusterer,drawing"></script>
<title>카카오지도</title>
    <style>
...
<div class="map_wrap">
    ...
    <div id="menu_wrap" class="bg_white">
        <div class="option">
            <div>
               <form>
                    키워드 : <input type="text" id="keyword" size="15" placeholder="장소검색"> 
        ...
        (function(marker, title) {
        	...
        	kakao.maps.event.addListener(marker, 'click', (function(placePosition) {
        	    ...
        	    return function() {
        	        ...
        	        $("#placeLa").val(placePosition.La);
        	        $("#placeLo").val(placePosition.Ma);
        	        $("#placeName").val(title);
        	        // #result 영역에 좌표정보 출력
        	...
        	출처: https://xianeml.tistory.com/75 [미현 개발 TIL]
